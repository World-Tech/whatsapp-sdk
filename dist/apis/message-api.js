    ...
    return {
        ...
        sendText: function (instance, body, apikey, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.MessageApiAxiosParamCreator)(configuration).sendText(instance, body, apikey, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
...
var MessageApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        sendText: function (instance, body, apikey, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.MessageApiFp)(configuration).sendText(instance, body, apikey, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
    };
...
var MessageApi = /** @class */ (function (_super) {
     ...
     * @memberof MessageApi
     */
    MessageApi.prototype.sendText = function (instance, body, apikey, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.MessageApiFp)(this.configuration).sendText(instance, body, apikey, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    return MessageApi;
