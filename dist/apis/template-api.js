...
exports.TemplateApi = exports.TemplateApiFactory = exports.TemplateApiFp = exports.TemplateApiAxiosParamCreator = void 0;
...
var TemplateApiAxiosParamCreator = function (configuration) {
    ...
    return {
         ...
         */
        getTemplates: function (instance_1, apikey_1) {
            var args_1 = [];
            for (var _i = 2; _i < arguments.length; _i++) {
                args_1[_i - 2] = arguments[_i];
            }
            return __awaiter(_this, __spreadArray([instance_1, apikey_1], args_1, true), void 0, function (instance, apikey, options) {
...
var TemplateApiFp = function (configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getTemplates: function (instance, apikey, options) {
            return __awaiter(this, void 0, void 0, function () {
                var localVarAxiosArgs;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.TemplateApiAxiosParamCreator)(configuration).getTemplates(instance, apikey, options)];
                        case 1:
...
var TemplateApiFactory = function (configuration, basePath, axios) {
    return {
        ...
        getTemplates: function (instance, apikey, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.TemplateApiFp)(configuration).getTemplates(instance, apikey, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
    };
...
var TemplateApi = /** @class */ (function (_super) {
     ...
     */
    TemplateApi.prototype.getTemplates = function (instance, apikey, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.TemplateApiFp)(this.configuration).getTemplates(instance, apikey, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    return TemplateApi;
